...
static gint __sort_app_status_info(gconstpointer p1, gconstpointer p2)
{
...
static void __kill_bg_uiapps(void)
{
	...
	app_status_info_list = g_slist_sort(app_status_info_list, (GCompareFunc)__sort_app_status_info);
