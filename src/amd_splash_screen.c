...
void _splash_screen_destroy_image(struct splash_image *si)
{
...
{
	struct splash_image *si = (struct splash_image *)data;
...
struct splash_image *_splash_screen_create_image(const struct appinfo *ai,
		bundle *kb, int cmd)
{
...
void _splash_screen_send_image(struct splash_image *si)
{
	struct splash_screen *ss;
...
void _splash_screen_send_pid(struct splash_image *si, int pid)
{
	struct splash_screen *ss;
