...
static bool listener_cbs_added = false;
...
{
	if (!listener_cbs_added) {
		_wayland_add_listener_cbs(__global_registry_handler,
				__global_registry_remover, NULL);
		listener_cbs_added = true;
	}
