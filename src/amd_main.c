...
void _cleanup_dead_info(app_status_h stat)
{
	int pid;
	int caller_pid;
...
static int __app_dead_handler(int pid, void *data)
{
	...
	tmp_appid = _app_status_get_appid(stat);;
	if (tmp_appid == NULL)
		return 0;
